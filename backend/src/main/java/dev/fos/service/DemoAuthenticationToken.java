 ...
 *
 * <p>Molde do {@link EmailAuthenticationToken}, e pelo mesmo motivo: o {@link CurrentUserProvider}
 * resolve o usuário pelo par {@code (provider, subject)} da própria autenticação, então cada forma
 * de entrar precisa de um tipo que ele reconheça. Ficar de fora dali é o defeito da #51 — o login
 * "funciona", a sessão existe, e toda chamada responde 401 sem erro no log.
 *
