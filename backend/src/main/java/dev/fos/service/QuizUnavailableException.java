 ...
 *
 * <p>Não é erro de programação: a curadoria de quiz é incremental (M0 e M1 primeiro). Vira 409 para
 * que o cliente mostre "quiz ainda não disponível" em vez de uma tela de erro.
 */
